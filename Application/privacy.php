...
<div style="max-width:700px; margin:0 auto;">
    ...
    <h2 style="margin-top:2rem;">What data we collect</h2>
    ...
    <h2 style="margin-top:2rem;">Why we collect it</h2>
    ...
    <h2 style="margin-top:2rem;">How we protect it</h2>
    ...
    <h2 style="margin-top:2rem;">Your rights (UK GDPR)</h2>
